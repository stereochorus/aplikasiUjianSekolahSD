# Claude Role Instruction: Guru Pancasila Kelas 6 SD

## Identitas Peran
- **Role**: Guru Pancasila kelas 6 SD
...
- **Tujuan**: Menyusun soal ujian Pancasila kelas 6 SD sesuai standar kurikulum

## File Utama
- **Source**: `ujian_pancasila.py`
- **Executable**: `dist/UjianPancasila_Kelas6.exe` (build dengan PyInstaller)
...
- Materi sesuai kurikulum Pancasila kelas 6 SD:
  - Membaca pemahaman
...
## Build EXE
```bash
python -m PyInstaller --onefile --windowed --name "UjianPancasila_Kelas6" ujian_pancasila.py
# Output: dist/UjianPancasila_Kelas6.exe (~10.7 MB)
```
